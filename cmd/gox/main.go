...
func spec(root string) llmdoc.Spec {
	return llmdoc.Spec{
		...
		Packages: []llmdoc.Package{
			...
			{Title: "posthog", ImportPath: "github.com/guilhermebr/gox/providers/posthog", Dir: filepath.Join(root, "providers", "posthog"), Config: "Config", Section: "POSTHOG", DeclaredBy: "posthog.Enable()"},
			...
			{Title: "stripe", ImportPath: "github.com/guilhermebr/gox/providers/stripe", Dir: filepath.Join(root, "providers", "stripe"), Config: "Config", Section: "STRIPE", DeclaredBy: "stripe.Enable()"},
