...
check-deps:
	@scripts/check-deps.sh examples/minimal absent github.com/jackc/pgx/v5 github.com/supabase-community/supabase-go github.com/workos/workos-go/v10 go.temporal.io/sdk github.com/pb33f/libopenapi github.com/riverqueue/river github.com/golang-jwt/jwt/v5 github.com/a-h/templ
	@scripts/check-deps.sh examples/http absent github.com/jackc/pgx/v5 github.com/supabase-community/supabase-go github.com/workos/workos-go/v10 go.temporal.io/sdk github.com/pb33f/libopenapi github.com/riverqueue/river github.com/golang-jwt/jwt/v5 github.com/a-h/templ
	@scripts/check-deps.sh examples/postgres present github.com/jackc/pgx/v5
	@scripts/check-deps.sh examples/postgres absent github.com/supabase-community/supabase-go github.com/workos/workos-go/v10 go.temporal.io/sdk github.com/pb33f/libopenapi github.com/riverqueue/river github.com/golang-jwt/jwt/v5 github.com/a-h/templ
	@scripts/check-deps.sh examples/web present github.com/a-h/templ
	@scripts/check-deps.sh examples/web absent github.com/jackc/pgx/v5 github.com/supabase-community/supabase-go github.com/workos/workos-go/v10 go.temporal.io/sdk github.com/pb33f/libopenapi github.com/riverqueue/river github.com/golang-jwt/jwt/v5
